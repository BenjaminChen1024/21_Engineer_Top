...
#define Debug_Yaw 0
#define Debug_Shoot 0
#define Debug_Gensui 0
#define Debug_Yuntai 0
/* Private variables ---------------------------------------------------------*/
...
void UpperMonitor_Sent_Choose(float * data)
{
  ...
  for(i=0;i<Sent_Data_Num;i++)
  {
    ...
    {
      /* 以下部分用于观察参数曲线 */
//			case 0: data[i] = Turn_PosPID.Target;
//			break;
//			case 1: data[i] = Turn_PosPID.Current;
//			break;
//			case 2: data[i] = Turn_SpdPID.Target;
//			break;
//			case 3: data[i] = Turn_SpdPID.Current;
//			break;

			case 0: data[i] = LeftLift_PosPID.Target;
			break;
			case 1: data[i] = LeftLift_PosPID.Current;
			break;
			case 2: data[i] = LeftLift_SpdPID.Target;
			break;
			case 3: data[i] = LeftLift_SpdPID.Current;
			break;
//			case 4: data[i] = Engineer_Sensor.PR_F1_Status * 10000;
//			break;
//			case 5: data[i] = Engineer_Sensor.PR_F2_Status * 10000;
//			break;
//			case 6: data[i] = Engineer_Motor.Lift_Motor.LeftLift_ZeroOffset;
//			break;
			case 4: data[i] = RightLift_PosPID.Target;
			break;
			case 5: data[i] = RightLift_PosPID.Current;
			break;
			case 6: data[i] = RightLift_SpdPID.Target;
			break;
			case 7: data[i] = RightLift_SpdPID.Current;
			break;

//			case 0: data[i] = LeftLift_Torque;
//			break;
//			case 1: data[i] = RightLift_Torque;
//			break;
...
void PARAMETER_MODIFICATION(uint8_t * PARAMETER)
{
  ...
  {
    /* 以下部分用于修改参数内容 */
//		case 0x00: Turn_PosPID.Kp =PARAMETER_Change_float(PARAMETER+1);
//          break;
//		case 0x01: Turn_PosPID.Ki =PARAMETER_Change_float(PARAMETER+1);
//          break;
//		case 0x02: Turn_PosPID.Kd =PARAMETER_Change_float(PARAMETER+1);
//          break;
//    case 0x03: Turn_SpdPID.Kp =PARAMETER_Change_float(PARAMETER+1);
//          break;
//		case 0x04: Turn_SpdPID.Ki =PARAMETER_Change_float(PARAMETER+1);
//          break;
//		case 0x05: Turn_SpdPID.Kd =PARAMETER_Change_float(PARAMETER+1);
//          break;
//		case 0x06: Turn_PosPID.Target =PARAMETER_Change_float(PARAMETER+1);
//          break;
//		case 0x07: Turn_SpdPID.Target =PARAMETER_Change_float(PARAMETER+1);
//          break;
//		case 0x08: Test_Extension_Pos =PARAMETER_Change_float(PARAMETER+1);
//          break;
     default:break;
	/* 以上部分用于修改参数内容 */
  }
